...
class Shopper_Activity_Favorite_Product(private val products: ArrayList<Shopper_Activity_Favorite_Product_Domain>) :
    RecyclerView.Adapter<Shopper_Activity_Favorite_Product.ViewHolder>() {

    private lateinit var context: Context

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.shopper_activity_favorite_products, parent, false)
